...
/**
 * A DTO for the ActivityConfig entity.
 */
public class ActivityConfigDTO extends AbstractAuditingDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        ActivityConfigDTO activityConfigDTO = (ActivityConfigDTO) o;
        if (activityConfigDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), activityConfigDTO.getId());
    }
