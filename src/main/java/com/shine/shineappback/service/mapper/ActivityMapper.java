 ...
 */
@Mapper(componentModel = "spring", uses = {TaskMapper.class, UserMapper.class, ClientMapper.class, ActivityRejectionMapper.class, ActivitySubmissionMapper.class, ActivityValidationMapper.class})
